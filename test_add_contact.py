...
class UntitledTestCase(unittest.TestCase):
    ...
    def create_contact(self, wd, firstname="Igor2", middlename="Nikolaev2", lastname="sdasd",
                       ...
                       email2="email2", email3="email3", homepage="homepage", bday="6", bmonth="June", byear="1985",
                       aday="9", amonth="July", ayear="2005", group="group1", address2="seconadary_address",
        ...
        # разобраться с этим
        wd.find_element_by_xpath("(//option[@value='9'])[2]").click()
